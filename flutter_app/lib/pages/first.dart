...
import 'package:air_guard/pages/airquality.dart';

// Local SensorData model (kept with radon for future use)
class SensorData {
...
class _FirstState extends State<First> {
  int _idx = 0;
  final _pages = const [Home(), DevicesScreen(), Thermostat(), Settings(), AirQuality()];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.home, color: Color.fromARGB(255, 76, 114, 175)), label: 'Home', ),
          BottomNavigationBarItem(icon: Icon(Icons.devices, color: Color.fromARGB(255, 196, 209, 142)), label: 'Devices'),
          BottomNavigationBarItem(
              icon: Icon(Icons.device_thermostat_outlined, color: Color.fromARGB(255, 243, 169, 85)),
              label: 'Thermostat'),
          BottomNavigationBarItem(
            icon: Icon(Icons.settings_accessibility_outlined, color: Color.fromARGB(255, 178, 137, 239)),
            label: 'Settings',
            ),
            BottomNavigationBarItem(
            icon: Icon(Icons.air_outlined, color: Colors.blueGrey),
            label: 'Air Quality',
            ),
        ],
      ),
...
// Home page — now with live Firebase data
...
class _HomeView extends StatelessWidget {
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(
                  ...
                  style: const TextStyle(
                      color: Color(0xFF7EB8D4), fontSize: 12)),
            ]),
            ...
            child:
              ...
              const Row(
                  ...
                  children: [
                    Text('Good',
                        style: TextStyle(
                            color: Color.fromARGB(255, 2, 168, 157),
                            fontSize: 10)),
                    Text('Moderate',
                        style: TextStyle(
  ...
  static Color _radonColor(double v) => v < 100
  ...
  static Color _humidColor(double v) => (v >= 30 && v <= 60)
      ? const Color.fromARGB(255, 2, 168, 157)
      : v > 60
          ? const Color(0xFFFFD93D)
          : const Color(0xFFFF6B6B);
  ...
  static Widget _summaryBanner(SensorData d) {
    ...
    final msg = d.radon >= 150
        ...
        : d.humidity > 60
            ? 'Humidity is high — a dehumidifier may help.'
            : d.humidity < 30
                ? 'Air is dry — consider a humidifier.'
